...
pub const NPC_CONTROLLER_SETTLE_DELAY_MIN: f32 = 0.14;
pub const NPC_CONTROLLER_SETTLE_DELAY_MAX: f32 = 0.30;
pub const NPC_PASS_DECISION_DELAY_MIN: f32 = 0.20;
pub const NPC_PASS_DECISION_DELAY_MAX: f32 = 0.55;
pub const NPC_PASS_EXECUTION_DELAY: f32 = 0.09;
pub const NPC_RECOVERY_TOUCH_DELAY: f32 = 0.08;
...
pub const TOUCH_UP_IMPULSE_JUGGLE: f32 = 6.4;
...
pub const BALL_CONTROL_RELEASE_DISTANCE: f32 = 2.8;
pub const BALL_RECOVERY_HEIGHT_THRESHOLD: f32 = BALL_RADIUS + 0.28;
pub const BALL_RECOVERY_POP_UP_SPEED: f32 = 5.8;
pub const BALL_RECOVERY_POP_FORWARD_SPEED: f32 = 1.2;
...
pub const BALL_LOOSE_CLAIM_RADIUS: f32 = 1.15;
pub const BALL_LOOSE_CLAIM_HEIGHT_MAX: f32 = 1.95;
pub const BALL_DEAD_SPEED_THRESHOLD: f32 = 0.36;
pub const BALL_GROUNDED_TIMEOUT: f32 = 1.0;

pub const RALLY_RESET_DELAY: f32 = 0.6;

pub const ELEGANCE_MAX: f32 = 100.0;
pub const ELEGANCE_PANIC_HEIGHT: f32 = 0.45;
pub const ELEGANCE_TOO_HIGH_HEIGHT: f32 = 2.7;

pub const ELEGANCE_JUGGLES_MIN_TARGET: u8 = 2;
pub const ELEGANCE_JUGGLES_SWEET_SPOT_MIN: u8 = 3;
pub const ELEGANCE_JUGGLES_SWEET_SPOT_MAX: u8 = 5;
pub const ELEGANCE_JUGGLES_MAX_TARGET: u8 = 6;
pub const ELEGANCE_JUGGLE_UNDER_TARGET_PENALTY_STEP: f32 = 1.6;
pub const ELEGANCE_JUGGLE_OVER_TARGET_PENALTY_STEP: f32 = 3.4;
